...
const LessonSchema = CollectionSchema(
  ...
  properties: {
    ...
    r'difficulty': PropertySchema(
      ...
      name: r'difficulty',
      type: IsarType.byte,
      enumMap: _LessondifficultyEnumValueMap,
    ),
...
Lesson _lessonDeserialize(
  ...
  object.difficulty =
      _LessondifficultyValueEnumMap[reader.readByteOrNull(offsets[2])] ??
...
P _lessonDeserializeProp<P>(
  ...
  switch (propertyId) {
    ...
    case 1:
      return (reader.readString(offset)) as P;
    case 2:
      return (_LessondifficultyValueEnumMap[reader.readByteOrNull(offset)] ??
          LessonDifficulty.beginner) as P;
    case 3:
...
const _LessondifficultyEnumValueMap = {
  'beginner': 0,
  'intermediate': 1,
  'advanced': 2,
};
const _LessondifficultyValueEnumMap = {
  0: LessonDifficulty.beginner,
  1: LessonDifficulty.intermediate,
  2: LessonDifficulty.advanced,
};
...
extension LessonQueryFilter on QueryBuilder<Lesson, Lesson, QFilterCondition> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> difficultyBetween(
    LessonDifficulty lower,
    LessonDifficulty upper, {
    bool includeLower = true,
    bool includeUpper = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> durationEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'duration',
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> durationGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> durationLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, Lesson, QAfterFilterCondition> durationBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
...
extension LessonQuerySortBy on QueryBuilder<Lesson, Lesson, QSortBy> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'duration', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> sortByDurationDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension LessonQuerySortThenBy on QueryBuilder<Lesson, Lesson, QSortThenBy> {
  ...
  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByDuration() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'duration', Sort.asc);
    });
  }

  QueryBuilder<Lesson, Lesson, QAfterSortBy> thenByDurationDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'duration', Sort.desc);
    });
  }
...
extension LessonQueryWhereDistinct on QueryBuilder<Lesson, Lesson, QDistinct> {
  ...
  QueryBuilder<Lesson, Lesson, QDistinct> distinctByDuration() {
    return QueryBuilder.apply(this, (query) {
...
extension LessonQueryProperty on QueryBuilder<Lesson, Lesson, QQueryProperty> {
  ...
  QueryBuilder<Lesson, LessonDifficulty, QQueryOperations>
      difficultyProperty() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Lesson, int, QQueryOperations> durationProperty() {
    return QueryBuilder.apply(this, (query) {
